...
class AcompanhanteOrdemServico(Entity):
	...
	@Object(name="AcompanhanteOrdemServicoTipo", key="id", reference="id_acompanhante_ordem_servico_tipo")
	def acompanhantes_ordens_servicos_tipos(self):pass

	@Object(name="Usuario", key="id", reference="id_usuario_criador")
	def usuarios(self):pass

	@Object(name="Usuario", key="id", reference="id_usuario_realizador")
	def usuarios(self):pass
