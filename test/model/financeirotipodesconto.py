...
class FinanceiroTipoDesconto(Entity):
	...
	@ObjectList(name="AcompanhanteAnuncio", key="id_tipo_desconto", reference="id", table="acompanhantes_anuncios")
	def acompanhantes_anuncios(self):pass

	@ObjectList(name="AcompanhanteCaseiraAdicional", key="id_tipo_desconto", reference="id", table="acompanhantes_caseiras_adicionais")
	...
	@ObjectList(name="AcompanhanteEnsaioEdicao", key="id_tipo_desconto", reference="id", table="acompanhantes_ensaios_edicoes")
	def acompanhantes_ensaios_edicoes(self):pass

	@ObjectList(name="Financeiro", key="id_tipo_desconto", reference="id", table="financeiros")
